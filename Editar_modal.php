...
<div class="modal fade" id="edit_<?php echo $row->codigo; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
			...
			<form method="POST" action="editar.php" enctype="multipart/form-data">
				<div class="row form-group">
					...
					<div class="col-sm-10">
						<input type="text" style="margin-left:15px;" class="form-control" name="codigo" value="<?php echo $row->codigo; ?>" readonly>
					</div>
				</div>
				<div class="row form-group">
					<div class="col-sm-2">
					...
					<div class="col-sm-10">
						<input type="text" style="margin-left:15px;" class="form-control" name="nombre" value="<?php echo $row->nombre; ?>">
					</div>
				</div>
				<div class="row form-group">
					<div class="col-sm-2">
					...
					<div class="col-sm-10">
						<input type="text" style="margin-left:15px;" class="form-control" name="descripcion" value="<?php echo $row->descripcion; ?>">
					</div>
				</div>
				<div class="row form-group">
					<div class="col-sm-2">
					...
					<div class="col-sm-10">
						<input type="file" style="margin-left:15px;" class="form-control" name="img" value="img/<?=$row->img?>" >
        ...
        <div class="row form-group">
          ...
          <div class="col-sm-10">
            <select name = "categoria" class="form-control" style="margin-left:15px;">
        ...
        <div class="row form-group">
          ...
          <div class="col-sm-10">
            <input type="number" style="margin-left:15px;" class="form-control" name="precio" value="<?=$row->precio?>">
          </div>
        </div>
        <div class="row form-group">
          <div class="col-sm-2">
          ...
          <div class="col-sm-10">
            <input type="number" style="margin-left:15px;" class="form-control" name="existencias" value="<?php echo $row->existencias; ?>">
          </div>
        </div>
      </div>
			</div>
